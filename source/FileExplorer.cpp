...
//         Color fg, bg;
//         if (fs::is_directory(path)) fg = _cfg.dir_color;
//         else fg = _cfg.file_color;
//         // if (idx == current_index) bg = _cfg.on_cursor_bg_color;
//         bg = _cfg.n_on_cursor_bg_color;
...
//     append_at_cursor(str, _cfg.dir_color);
//     if (str[str.size()-1] != '/') append_at_cursor('/', _cfg.dir_color);
//     append_at_cursor(file_name, _cfg.file_color);
//     append_at_cursor('\n');
// 
//     list_entries();
// }
...
//     //         set_cells_color(start, line_size[idx+1], nullopt, _cfg.on_cursor_bg_color);
//     //     }
//     //     current_index = idx;
//     // }
// }
...
//         render_cursor.x += _cfg.char_w(buffer[i].c);
//     }
...
//             render_cursor.x += _cfg.char_w(cell.c);
//         }
//     }
// }
